...
export default function PDFToDocxPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const name = file.name.replace(".pdf", ".docx");
      setDownloadUrl(url);
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        >
          <div style={{
            ...
            <FileInput style={{ width: "28px", height: "28px", color: "#854F0B" }} />
          </div>
          <h1 style={{
          ...
          <p style={{ fontSize: "16px", color: "#71717a", margin: "0 0 16px" }}>
            Convert PDF back to an editable Word document.
          </p>
          {/* Honest formatting note */}
          <div style={{
            ...
            ⚠️ Complex layouts may vary slightly — formatting is preserved as much as possible.
          </div>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "16px", color: isDragActive ? "#f59e0b" : "#71717a", margin: "0 0 8px" }}>
                {isDragActive ? "Drop your PDF here" : "Drag & drop a PDF file, or click to browse"}
              </p>
            ...
            >
              ...
              >
                {status === "converting" ? (
                  ...
                  <>
                    <FileInput style={{ width: "18px", height: "18px" }} />
                    Convert to DOCX
                  </>
                )}
              </button>
